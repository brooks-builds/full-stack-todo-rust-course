...
| Dynamically Setting the API_URI    | x        | http                      | We want to have one API URI for dev, and one for production                                                                           |                              |
| Introducing the Project            | x        | Introducing the Project   | Getting the backend up and running and exploring the API                                                                              |                              |
| Project Solution Live Code - 1     | x        |                           |                                                                                                                                       |                              |
| Project Solution Live Code - 2     | x        |                           |                                                                                                                                       |                              |
| Project Solution Live Code - 3     | x        |                           |                                                                                                                                       |                              |
| Project Solution Live Code - 4     | x        |                           |                                                                                                                                       |                              |
| Project Solution Live Code - 5     | x        |                           |                                                                                                                                       |                              |
