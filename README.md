...
| struct messages                    | x        | struct components         | Saving state in a struct component uses message passing                                                                               |                              |
| Setting up Yewdux                  | x        | stores                    | Yewdux is very similar to Redux for state management                                                                                  |                              |
| Using Yewdux to Store Form Data    | x        | stores                    | We want to create a form and save it's data to the Yewdux store                                                                       |                              |
